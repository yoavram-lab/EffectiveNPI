...
\begin{figure}[h]
    ...
    \textbf{Official and effective start of non-pharmaceutical interventions.}
    	The difference between $\hat{\tau}$ the effective and $\tau^*$ the official start of NPI is shown for different regions. For values of $\hat{\tau}$ the MAP estimate, see \hl{TABLE2}. For $\tau^*$ values, see \autoref{table:table1}. % TODO add CI
    }
    \label{fig:fig1}
\end{figure}
