...
\caption{Official start of non-pharmaceutical interventions. In all countries except Sweden, the date is for the start of a lockdown. In Sweden, where a lockdown was not ordered during the duration of the study, the date is for start ofschool closures. Dates for European countries from \citet{Flaxman2020}, date for Wuhan, China from \citet{Pei2020}.}
\label{table:table1}
\end{table}
