...
Keywords: SEIR, COVID-19, public health, pandemic, infectious disease
...
\end{aligned}
\end{equation}
The relative reduction in the effective reproduction number due to NPIs is $\frac{R_1 - R_2}{R1}$.
