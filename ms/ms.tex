...
% TODO update when ppc fig is ready
...
\autoref{fig:Re} demonstrates that estimates from the fixed~$\tau$ model are consistently lower than estimates from the free~$\tau$ model, except in Sweden and Denmark, in which estimation uncertainty is high.   %TODO update when fig Re is ready
...
The IAT was between 40K for Norway and 187K for Germany~(\autoref{fig:autocorr}).
We examined the trace plots for $\tau$ in all regions (\autoref{fig:trace}).
All chains seem to converge to the same stationary distribution, in most cases before 2M steps. Thus, we discarded the first 2M samples as burn-in samples.
The only exception is Spain, in which a single chain converged at around 6M steps.
We considered this chain as part of the burn-in and removed it from the analysis.
Therefore, 50 chains with 5M samples and IAT between 40K and 187K give an effective number of uncorrelated samples between 1,335 and 6,250.
...
We also examined the joint posterior distributions of $\tau$ and $\lambda$ to check for correlations (FIGURE). %TODO what do we find?
...
We thank Yinon M. Bar-On, Lilach Hadany, and Oren Kolodny for discussions and comments. % Tim CD Lucas
} % small
...
% TODO update after changes requested email 20 Jan
\begin{figure}[h]
    \centering
...
\begin{figure}[p]	
    ...
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Austria_trace3.png}
    \end{subfigure}
    ~%%%
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Belgium_trace3.png}
    \end{subfigure}
    ~%%%
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Denmark_trace3.png}
    \end{subfigure}
	~%%%
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/France_trace3.png}
    \end{subfigure}
    ~%%%
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Germany_trace3.png}
    \end{subfigure}
    ~%%% 
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Italy_trace3.png}
    \end{subfigure}
    ~%%% 
	\begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Norway_trace3.png}
    \end{subfigure}
    ~%%%  
	\begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Spain_trace3.png}
    \end{subfigure}
    ~%%%
	\begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Sweden_trace3.png}
    \end{subfigure}
    ~%%%  
	\begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Switzerland_trace3.png}
    \end{subfigure}
    ~%%%  
	\begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/United_Kingdom_trace3.png}
    \end{subfigure}
    ~%%%  
	\begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../figures/traces/Wuhan_trace3.png}
    \end{subfigure}
    \caption{    % TODO update according to requests from Ilia Jan 20 email
