...
%TODO 
% clearly mention that you estimate an aggregated effect for all measures and a single date for when the effect of the measures begins, even though in real life the measures were spread out in time and each one probably has a different effect.
