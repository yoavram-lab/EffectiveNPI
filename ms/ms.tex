...
In this model, $Y_t= \alpha_t E(t)/Z$ is the \emph{expected} number of new reported infected individuals on day $t$.
We also define $\tilde{Y}_t$ to be the expected cumulative number of reported infected individuals up to day $t$,
$$
