...
\textbf{Results.}
We infer mostly late, but also early effects of interventions. For example, Italy implemented a nationwide lockdown on Mar~11, but we infer the effective start date on Mar~17 ($\substack{+3.05 \\ -2.01}$~days 95\%~CI).
