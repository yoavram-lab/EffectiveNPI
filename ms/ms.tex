...
For the effective start of NPIs $\tau$ we have also tested an uninformative uniform prior $U(1,T-1)$. DIC (see below) was lower for the truncated normal prior in all countries except \hl{Germany?}, and therefore we decided to use the informative prior.
