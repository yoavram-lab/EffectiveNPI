...
However, the credible intervals are quite wide (\autoref{fig:tau-summary}), and in Denmark and Sweden the evidence did not support the model with free~$\tau$ over the model with $\tau$ fixed at the official date (\autoref{table:WAIC}).
